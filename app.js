...
/*-------------WIN MODAL MESSAGE (timer/moves dependant)--------------*/
                    ...
                    $(function () {
                        ...
                        if (rating <= 60) {
                            y = `<span class="rate"><i class="fa fa-star"></i>
                        ...
                        setTimeout(function () {
                            ...
                            modalInfo.innerHTML = `You won! It took you only ${(timeTaken).toFixed(0)}
                            seconds and ${moveCounter} moves! Your star rating is: ${y}`;
                        }, 500)
                    });
